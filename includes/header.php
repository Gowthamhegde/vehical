            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-map-marker"></i> <?php  echo "MayurVehicles, GoldFinch City, Mangalore Karnataka-India";?>
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-mobile"></i> +91<?php  echo " 9898989898";?>
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-envelope"></i> <?php  echo "mayurvehicles@gmail.com";?>
                    </div>
                    <!--== Single HeaderTop End ==-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="index.php" class="logo">
                            <h2 style="color: white">Vehicles.com</h2>
                        </a>
                    </div>
                    <!--== Logo End ==-->
